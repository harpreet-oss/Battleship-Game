	...
	private void initializeComponents() 
	{
		...
		btnNewGame.addActionListener(new ActionListener() 
		{
			public void actionPerformed(ActionEvent arg0) 
			{
				...
				{
					gui.StopSingleGame();
					gui.writeOutputMessage(" - You have to reallocate your ships and press on Start Game!");
				}
				else
				{
					if (gui.IsServer())
		...
		btnClose.addActionListener(new ActionListener() 
		{
			public void actionPerformed(ActionEvent arg0) 
			{
				...
				if (gui.isSinglePlayer())
				{
					...
					gui.writeOutputMessage(" - If you decide to play again, you have to reallocate your ships and press Start Game!");
				}
				else
				{
					if (gui.IsServer())
		...
		urlBtn.setText("<HTML><FONT color=\"#000099\"><U>http://www.help.com</U></FONT></HTML>");
	    ...
	    urlBtn.setToolTipText("http://www.help.com");
