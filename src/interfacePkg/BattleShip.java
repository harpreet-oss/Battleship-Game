						...
						if (PlayAgainsPC)
						{
							if (myMapUpdate.getMyTurn())
							{
								...
								if (myEnemyMapUpdate.isPositionLegal(index))
								{
									...
									{
										JOptionPane.showMessageDialog(myFrame, "You have already hit this position, try another one.");
									}
									else
									{
										//inform
										writeOutputMessage(" - Your bomb goes to: "+myEnemyMapUpdate.getLine(index)+myEnemyMapUpdate.getColumn(index));
								...
								{
									JOptionPane.showMessageDialog(myFrame, "You tried to play in a not legal position. Please, choosen another position on the board.");
								}
							}
						}
						else
	    ...
	    this.btnConnect.addActionListener(new ActionListener() 
	    {
	    	public void actionPerformed(ActionEvent arg0) 
	    	{
	    		...
	    		if (PlayAgainsPC)
	    		{
    				...
    				{
    					JOptionPane.showMessageDialog(myFrame, "You have to allocate your ships before you start the game.");
    				}
	    		}
	    		else
	    		{
	    			...
	    			if (IsServer)
	    			{
	    				...
	    				{
	    					JOptionPane.showMessageDialog(myFrame, "You have to write the server's IP address and the port before start the game.");	
	    				}
	    				else
	    				{
	    					//create my server thread
